...
def carregar_musicas():
    caminhos_do_arquivo = filedialog.askopenfilenames(title="Selecione músicas", filetypes=[("Arquivos de áudio", "*.mp3")])
...
# Comandos dos botões
botao_carregar = ttk.Button(janela, text="Carregar Músicas", command=carregar_musicas)
